            ...
            >
                ...
                <p
                    className="
                        ...
                        text-[length:var(--caption-regular-font-size)]
                        font-[number:var(--caption-regular-font-weight)]
                        leading-[var(--caption-regular-line-height)]
                        tracking-[var(--caption-regular-letter-spacing)]
                        text-[#ac937e]
                ...
                <h2
                    className="
                        font-headings-h1
                        text-[length:var(--headings-h1-font-size)]
                        font-[number:var(--headings-h1-font-weight)]
                        leading-[var(--headings-h1-line-height)]
                        tracking-[var(--headings-h1-letter-spacing)]
                        text-[#2e2c2a]
                    ...
                    {climateFeatures.map((feature, index) => (
                        ...
                        >
                            <dt
                                className="
                                    font-body-bold
                                    text-[length:var(--body-bold-font-size)]
                                    font-[number:var(--body-bold-font-weight)]
                                    leading-[var(--body-bold-line-height)]
                                    tracking-[var(--body-bold-letter-spacing)]
                                    text-[#2e2c2a]
                ...
                <div className="flex w-full flex-col items-start gap-4">
                    <h3
                        className="
                            font-headings-h4
                            text-[length:var(--headings-h4-font-size)]
                            font-[number:var(--headings-h4-font-weight)]
                            leading-[var(--headings-h4-line-height)]
                            tracking-[var(--headings-h4-letter-spacing)]
                            text-[#2e2c2a]
                            ...
                            >
                                <p
                                    className="
                                        ...
                                        tracking-[1px]
                                        text-[#2e2c2a]
                                        [font-family:'Gelion-Bold',Helvetica]
                                        text-[16px]
                        ...
                        >
                            ...
                            <span
                                className={`
                                    ...
                                    ${
                                        activeSlide === index
                                            ? "h-[16px] w-[16px] bg-[#ac937e]"
                                            : "h-[16px] w-[16px] bg-white hover:bg-white/80"
                                    }
                                `}
                            />
