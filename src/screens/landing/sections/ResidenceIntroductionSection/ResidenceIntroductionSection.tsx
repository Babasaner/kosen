...
export const ResidenceIntroductionSection = (): JSX.Element => {
    return (
        <section id="concept" className="flex flex-col lg:flex-row w-full self-stretch items-start lg:items-end justify-between bg-[#e6ded8] gap-12 lg:gap-0 px-5 py-16 sm:px-10 lg:px-20 lg:py-[120px]">
            <div className="flex w-full lg:w-[555px] flex-col items-start">
                ...
                <p className="flex self-stretch items-center [font-family:'Lora',Helvetica] text-[40px] leading-[40px] sm:text-[74.9px] font-normal italic sm:leading-[74.9px] tracking-[-1.5px] sm:tracking-[-2.62px] text-[#ac937e] mt-2 lg:mt-0">
